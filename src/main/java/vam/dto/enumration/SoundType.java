...
public enum SoundType {
	...
	PORN_WORDS(Arrays.asList("淫語")), BLOW(Arrays.asList("BLOW")), KISS(Arrays.asList("KISS")),
	BREATH(Arrays.asList("BREATH")), PHONERING(Arrays.asList("PHONERING")), NORMAL(Arrays.asList("BUSINESS")),
	PAPACUM(Arrays.asList("PAPACUM")),;
